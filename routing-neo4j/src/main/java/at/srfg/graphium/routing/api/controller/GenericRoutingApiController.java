 ...
 */
package at.srfg.graphium.routing.api.controller;
...
import at.srfg.graphium.routing.model.dto.impl.RoutingErrorDtoImpl;
import at.srfg.graphium.routing.model.exception.RoutingException;
import at.srfg.graphium.routing.service.IRoutingService;

public abstract class GenericRoutingApiController<T extends IWaySegment> {
